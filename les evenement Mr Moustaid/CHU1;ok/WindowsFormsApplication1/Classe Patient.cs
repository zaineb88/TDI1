...
namespace WindowsFormsApplication1
{
    class Classe_Patient
    {
        ...
        {
            get { return Classe_Patient.compteur; }
            set { Classe_Patient.compteur = value; }
        }
        ...
        public Classe_Patient(string nom, string prénom) //constructeur
        {
            compteur++;
        ...
        {
            return _CodePatient + " : " + _Nom + " : " + _Prénom + " : " + _Dt.ToShortDateString() + " : " + _Adresse + " : " + _télé + " : " + _Email;
        } 
    }
}
